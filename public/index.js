...
(function e(t, n, r) {
  function s(o, u) {
    ...
    !(function (global, framework, undefined) {
      ...
      var OBJECT = "Object",
        ...
        var iterator = getIterator(iterable),
            ...
            step;while (!(step = iterator.next()).done) if (stepCall(f, step.value, entries) === false) return;
        ...
        isFunction(Promise) && isFunction(Promise.resolve) && Promise.resolve(test = new Promise(function () {})) == test || (function (asap, DEF) {
          function isThenable(o) {
            ...
            var def = this,
                then,
                wrapper;if (def.done) return;def.done = true;def = def.def || def;try {
            ...
            var def = this;if (def.done) return;def.done = true;def = def.def || def;def.msg = msg;def.state = 2;notify(def);
        ...
        function Enumerate(iterated) {
          ...
          var receiver = arguments.length < 3 ? target : arguments[2],
              ...
              proto;if (desc) return has(desc, "value") ? desc.value : desc.get === undefined ? undefined : desc.get.call(receiver);return isObject(proto = getPrototypeOf(target)) ? reflectGet(proto, propertyKey, receiver) : undefined;
    ...
    (function (global) {
      !(function (global) {
        "use strict";
        var hasOwn = Object.prototype.hasOwnProperty;var undefined;var iteratorSymbol = typeof Symbol === "function" && Symbol.iterator || "@@iterator";var inModule = typeof module === "object";var runtime = global.regeneratorRuntime;if (runtime) {
          if (inModule) {
